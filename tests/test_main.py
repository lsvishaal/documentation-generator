...
async def test_handler_returns_response():
    ...
    with (
        patch("documentation_generator.main._initialized", True),
...
async def test_handler_initialization():
    ...
    with (
        patch("documentation_generator.main._initialized", False),
        patch("documentation_generator.main.initialize_all", new_callable=AsyncMock),
        patch("documentation_generator.main.run_agent", new_callable=AsyncMock, return_value=mock_response),
